...
public class MemUpdateOkMemCommand implements MemberInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String noimageCheck = multipartRequest.getParameter("noimageCheck") == null ? "no" : multipartRequest.getParameter("noimageCheck");
		...
		else if(noimageCheck.equals("noimage")) {
			vo.setFile_name("noimage.jpg");
			vo.setSave_file_name("noimage.jpg");
		}
		else {
			vo.setFile_name("");
