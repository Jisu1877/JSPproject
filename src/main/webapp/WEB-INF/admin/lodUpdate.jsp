...
<script>
   	...
   	function photoDel(fName) {
   		$.ajax({
   			type : "post",
   			url : "${ctp}/photoDeleteCommand",
   			data : {fName : fName},
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <p><br/><p>
	  <div class="w3-container" id="contact">
	    <h2 class="headerJoin text-center">Lodging Update</h2>
			    		...
			    		<div class="w3-row-padding w3-padding-16">
			      		<div class="input-group mb-3 w3-third">
				            ...
				            <select class="w3-select w3-border" id="category_code" name="category_code">
				            	...
				            	<option value="100" ${lodVo.category_code == '100' ? 'selected' : ''}>유럽</option>
				            	<option value="101" ${lodVo.category_code == '101' ? 'selected' : ''}>아시아</option>
				            	<option value="102" ${lodVo.category_code == '102' ? 'selected' : ''}>미국</option>
				            	<option value="103" ${lodVo.category_code == '103' ? 'selected' : ''}>프랑스</option>
				            	<option value="104" ${lodVo.category_code == '104' ? 'selected' : ''}>이탈리아</option>
				            	<option value="105" ${lodVo.category_code == '105' ? 'selected' : ''}>기타</option>
				            </select>
			    		</div>
			    		<div class="input-group mb-3 w3-third">
				            ...
				            <select class="w3-select w3-border" id="sub_category_code" name="sub_category_code">
				            	...
				            	<option value="200" ${lodVo.sub_category_code == '200' ? 'selected' : ''}>대형(침실 5개이상)</option>
				            	<option value="201" ${lodVo.sub_category_code == '201' ? 'selected' : ''}>중형(침실 2개이상)</option>
				            	<option value="202" ${lodVo.sub_category_code == '202' ? 'selected' : ''}>소형(침실 1개)</option>
				            </select>
			    		</div>
			    		<div class="input-group mb-3 w3-third">
				            ...
				            <select class="w3-select w3-border" id="detail_category_code" name="detail_category_code">
				            	...
				            	<option value="300" ${lodVo.detail_category_code == '300' ? 'selected' : ''}>최고의 전망</option>
				            	<option value="301" ${lodVo.detail_category_code == '301' ? 'selected' : ''}>디자인</option>
				            	<option value="302" ${lodVo.detail_category_code == '302' ? 'selected' : ''}>해변근처</option>
				            	<option value="303" ${lodVo.detail_category_code == '303' ? 'selected' : ''}>캠핑장</option>
				            	<option value="304" ${lodVo.detail_category_code == '304' ? 'selected' : ''}>돔하우스</option>
				            	<option value="305" ${lodVo.detail_category_code == '305' ? 'selected' : ''}>동굴</option>
				            	<option value="306" ${lodVo.detail_category_code == '306' ? 'selected' : ''}>서핑</option>
				            	<option value="307" ${lodVo.detail_category_code == '307' ? 'selected' : ''}>호숫가</option>
				            	<option value="308" ${lodVo.detail_category_code == '308' ? 'selected' : ''}>한적한 시골</option>
				            	<option value="309" ${lodVo.detail_category_code == '309' ? 'selected' : ''}>열대지역</option>
				            	<option value="310" ${lodVo.detail_category_code == '310' ? 'selected' : ''}>통나무집</option>
				            	<option value="311" ${lodVo.detail_category_code == '311' ? 'selected' : ''}>멋진 수영장</option>
				            	<option value="312" ${lodVo.detail_category_code == '312' ? 'selected' : ''}>캐슬</option>
				            	<option value="313" ${lodVo.detail_category_code == '313' ? 'selected' : ''}>북극</option>
				            </select>
			    		</div>
			    		</div>
			    	</div>
				    	...
				    	<div class="w3-col m8 l8 w3-margin-bottom">
					    	<div class="form-group">
					    		<label for="lod_name">숙소명 : &nbsp; &nbsp;</label>
					      		<div class="input-group mb-3">
					    			<input class="input w3-padding-16 w3-border form-control" id="lod_name" name="lod_name" type="text" value="${lodVo.lod_name}" readonly>
					    		</div>
					    		<div style="font-size:0.9em; color:grey; margin-top:0px"><i class="fa-solid fa-circle-exclamation"></i> 숙소명은 수정이 불가합니다.</div>
					    	</div>
					    	<div class="form-group">
					    		<label for="price">가격&nbsp; [1박 기준] : &nbsp; &nbsp;</label>
					      		<div class="input-group mb-3" style="margin-bottom:0px">
					    			<input class="input w3-padding-16 w3-border form-control" value="${lodVo.price}" id="price" name="price" type="number" placeholder="숙소 가격을 입력하세요." required>
				    		...
				    		<div class="form-group">
					    		<label for="number_guests">숙박 가능 최대 인원수 : &nbsp; &nbsp;</label>
					      		<div class="input-group mb-3">
					    			<input class="input w3-padding-16 w3-border form-control" value="${lodVo.number_guests}" id="number_guests" name="number_guests" type="number" maxlength="3" min="0" max="100" placeholder="숙박 가능 인원수룰 입력하세요." required>
					    		</div>
					    	</div>
				    		<div class="form-group">
				      		...
				      		<div class="input-group mb-3">
				    			 <select class="w3-select w3-border" id="country" name="country">
				    			 	<optgroup label="country">
										...
										<option value="${lodVo.country}" selected>${lodVo.country}</option>
				    		...
				    		<div class="form-group">
					    		<label for="address">주소 : &nbsp; &nbsp;</label>
					      		<div class="input-group mb-3">
					    			<input class="input w3-padding-16 w3-border form-control" value="${lodVo.address}" id="address" name="address" type="text" placeholder="숙소 주소룰 입력하세요." required>
					    		</div>
					    	</div>
					    	<div class="form-group">
					    		<label for="explanation">숙소 상세 설명 : &nbsp; &nbsp;</label>
					      		<div class="input-group mb-3">
					    			<textarea rows="5" class="input w3-padding-16 w3-border form-control" id="explanation" name="explanation" placeholder="숙소 상세 설명을 입력하세요." style="resize: none;"  required>${lodVo.explanation}</textarea>
					    		</div>
					    	</div><p><br></p>
									...
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="air_conditioner" value="n" ${lodVo.option.air_conditioner == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="air_conditioner" value="y" ${lodVo.option.air_conditioner == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="tv" value="n" ${lodVo.option.tv == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="tv" value="y" ${lodVo.option.tv == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="wifi" value="n" ${lodVo.option.wifi == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="wifi" value="y" ${lodVo.option.wifi == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="washer" value="n" ${lodVo.option.washer == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="washer" value="y" ${lodVo.option.washer == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="kitchen" value="n" ${lodVo.option.kitchen == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="kitchen" value="y" ${lodVo.option.kitchen == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="heating" value="n" ${lodVo.option.heating == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="heating" value="y" ${lodVo.option.heating == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="form-check">
											    <input type="radio" name="toiletries" value="n" ${lodVo.option.toiletries == 'n' ? 'checked' : ''}>&nbsp;&nbsp;없음&nbsp;&nbsp;&nbsp;
											    <input type="radio" name="toiletries" value="y" ${lodVo.option.toiletries == 'y' ? 'checked' : ''}>&nbsp;&nbsp;있음
											</div>
									  </div>
								   </div>
								</td>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="input-group mb-3">
								    			&nbsp;&nbsp;&nbsp;&nbsp;<input class="input w3-padding-16 w3-border form-control" value="${lodVo.option.bedroom}" id="bedroom" name="bedroom" type="number" maxlength="3" min="0" max="100" required>
								    		</div>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="input-group mb-3">
								    			&nbsp;&nbsp;&nbsp;&nbsp;<input class="input w3-padding-16 w3-border form-control" value="${lodVo.option.bed}" id="bed" name="bed" type="number" maxlength="3" min="0" max="100" required>
								    		</div>
								    		<span class="mb-3">&nbsp;&nbsp;개</span>
									 	  </div>
								   	</div>
						  	...
						  	<tr>
								...
								<td>
									<div class="form-group">
									      <div class="form-check-inline">
								        	<div class="input-group mb-3">
								    			&nbsp;&nbsp;&nbsp;&nbsp;<input class="input w3-padding-16 w3-border form-control" value="${lodVo.option.bathroom}" id="bathroom" name="bathroom" type="number" maxlength="3" min="0" max="100" required>
								    		</div>
								    		<span class="mb-3">&nbsp;&nbsp;개</span>
									 	  </div>
								   	</div>
