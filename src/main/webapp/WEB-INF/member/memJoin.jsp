...
<p><br/><p>
<div class="container" style="padding:30px; width:1000px; margin: 0px auto;">
  <form name="myForm" method="post" action="${ctp}/memJoinOk.mem" class="was-validated">
    <div class="headerJoin">JOIN</div>
    <br/>
    <div class="form-group">
      ...
      <div class="input-group mb-3">
	      ...
	      <div class="input-group-append">
	      	<input type="button" value="아이디 중복체크" class="btn w3-theme" onclick="idCheck()"/>
	      </div>
