...
<div class="w3-bar w3-white w3-large">
  <a href="<%=request.getContextPath()%>/" class="w3-bar-item w3-button w3-theme w3-mobile"><i class="fa-solid fa-tents"></i>&nbsp;Fantastic Lodging</a>
  ...
  <%  if(level != 99) { %>
  		<a href="<%=request.getContextPath()%>/memLogOut.mem" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">Logout</a>
  <% } else {%>
  		<a href="<%=request.getContextPath()%>/memLogin.mem" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">Login</a>
  <% } %>
  <% if(level == 0) { %>
		<a href="<%=request.getContextPath()%>/adminHome.ad" class="w3-bar-item w3-button w3-right w3-black w3-mobile">Admin</a>
  <% } else if(level == 99) { %>
